        ...
        <form name="form" id="form" action="<?php echo $view->urlAction ?>" method="post">
            ...
            <fieldset>
                ...
                <div id="contato" class="toggleDiv">
                    ...
                    <div class="entrada"><input type="text" id="nascimento" name="dt_nasc" placeholder="00/00/0000" value=""/></div>
                    <div class="rotulo"><label for="email">E-mail: </label></div>
                    <div class="entrada"><input type="email" id="email" name="email" placeholder="Endereço de e-mail" value=""/></div>
                    <div class="rotulo"><label for="tel_res">Telefone Residencial: </label></div>
                    <div class="entrada"><input type="text" id="tel_res" name="telefone_res" placeholder="(000)0000-0000" maxlength="16" value=""/></div>
                    <div class="rotulo"><label for="tel_cel">Telefone Celular: </label></div>
                    <div class="entrada"><input type="tel" id="tel_cel" name="telefone_cel" placeholder="(000) 0000-0000" maxlength="17" value=""/></div>
                    <div class="rotulo"><label for="tel_com">Telefone Comercial: </label></div>
                    <div class="entrada"><input type="text" id="tel_com" name="telefone_com" placeholder="(000) 0000-0000" maxlength="16" value=""/></div>
                    <div class="rotulo"><label for="endereco">Endereço: </label></div>
                    <div class="entrada"><input type="text" id="endereco" name="endereco" placeholder="Rua, Avenida e etc." value=""/></div>
                    <div class="rotulo"><label for="cidade">Bairro: </label></div>
                    <div class="entrada"><input type="text" id="bairro" name="bairro" placeholder="Bairro" value=""/></div>
                    <div class="rotulo"><label for="cidade">Cidade: </label></div>
                    <div class="entrada"><input type="text" id="cidade" name="cidade" placeholder="Cidade" value=""/></div>
                    <div class="rotulo"><label for="uf">Estado: </label></div>
                    <div class="entrada"><input type="text" id="uf" name="uf" maxlength="2" value=""/></div>
                    <div class="rotulo"><label for="cep">CEP: </label></div>
                    <div class="entrada"><input type="text" id="cep" name="cep" placeholder="00000-000" maxlength="9" value=""/></div>
                </div>
            </fieldset>
            <fieldset>
                ...
                <div id="pessoal" class="toggleDiv">
                    ...
                    <div class="entrada"><input type="text" id="formacao" name="formacao" placeholder="Grau de Estudo" value=""/></div>
                    <div class="rotulo"><label for="empresa">Empresa: </label></div>
                    <div class="entrada"><input type="text" id="empresa" name="empresa" placeholder="Nome da Empresa" value=""/></div>
                    <div class="rotulo"><label for="admissao">Data de Admissão: </label></div>
                    <div class="entrada"><input type="date" id="admissao" name="dt_adm" value=""/></div>
                </div>
            </fieldset>
            <fieldset>
                <div class="rotulo">
